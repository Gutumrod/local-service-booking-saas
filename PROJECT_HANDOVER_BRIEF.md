...
> **สถานะปัจจุบัน:** **Phase A-D + E1-E3.3 ผ่าน live verification แล้ว**; E4.1-E4.6 ผ่าน live verification ก่อนหน้า และ **E4.7-E4.9 (Launch-1): migration apply แล้ว, booking-acceptance gate (E4.8) verify live ครบทุก state แล้ว (2026-08-13)** — เหลือแค่ billing tab UI/Checkout-Portal ใน browser ที่ยังไม่มีใครล็อกอินเช็คจริง และ production Stripe config (E4.9 ส่วน manual) — ดู [`docs/technical/PHASE_LAUNCH_1_COMPLETION_REPORT_2026-08-12.md`](docs/technical/PHASE_LAUNCH_1_COMPLETION_REPORT_2026-08-12.md) หัวข้อ "2026-08-13 live-gate results" และ [`docs/technical/BRIEF_PHASE_E4_STRIPE_BILLING.md`](docs/technical/BRIEF_PHASE_E4_STRIPE_BILLING.md)
...
- สถานะ 6 แท็บ (อัปเดต 2026-08-08 หลัง E3.3):
  ...
  6. `billing` 🟡 **Query จริงยืนยันแล้ว, UI ยังไม่ล็อกอินเช็ค:** owner query `subscriptions` ภายใต้ RLS ยืนยันข้อมูลถูกต้องแล้ว (2026-08-13), แสดง plan/status/รอบสิทธิ์/ยกเลิกปลายรอบ/past_due และ Checkout/Portal ใช้ Stripe เดิม; เอา quota/usage/add-on/annual/PromptPay subscription mock ออกแล้ว. **ยังไม่มีใครล็อกอินเข้าไปดูหน้าจอจริงหรือกดปุ่ม Checkout/Portal จริง** ต้องทำก่อนเรียกว่าเสร็จ
...
- 🟡 **Phase E4 (กำลังทำ):** ดู checklist เต็มที่ [`BRIEF_PHASE_E4_STRIPE_BILLING.md`](docs/technical/BRIEF_PHASE_E4_STRIPE_BILLING.md)
  ...
  - 🟡 **E4.7 billing tab เลิก mock:** query `subscriptions` จริงยืนยันแล้ว (2026-08-13); ตัว UI/ปุ่ม Checkout-Portal ในเบราว์เซอร์ยังไม่ได้ล็อกอินเช็คจริง (auto-login ผ่าน magic link ทำไม่สำเร็จ) — ต้องมีคนล็อกอินเช็คเอง
