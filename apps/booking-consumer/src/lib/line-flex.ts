        ...
        contents: [
          {
            ...
            action: {
              type: "uri",
              label: "รับการแจ้งเตือนผ่าน LINE OA",
              uri: data.lineOaUrl
            },
            style: "primary",
            color: "#06C755"
    ...
    contents: {
      ...
      header: {
        ...
        contents: [
          {
            type: "text",
            text: "🔔 มีคิวจองใหม่เข้ามา (รอตรวจสลิป)",
            weight: "bold",
            color: "#F59E0B",
            size: "xs"
          },
      ...
      body: {
        ...
        contents: [
          ...
          {
            type: "text",
            text: `เวลานัด: ${data.date} @ ${data.time} น.`,
            size: "xs",
            color: "#38BDF8",
            margin: "xs"
          },
          {
            type: "text",
            text: `ยอดมัดจำที่ต้องตรวจสอบ: ฿${data.depositAmount}.00`,
            size: "xs",
            color: "#10B981",
            weight: "bold",
            margin: "xs"
