    ...
    <main className="min-h-screen bg-slate-950 text-slate-100 flex items-center justify-center p-4">
      <form onSubmit={handleSubmit} className="w-full max-w-md rounded-2xl border border-slate-800 bg-slate-900 p-6 space-y-5">
        ...
        <div className="flex justify-between text-xs">
          <Link href="/forgot-password" className="text-slate-400 hover:text-white">ลืมรหัสผ่าน</Link>
          <Link href="/register" className="text-emerald-400 hover:text-emerald-300">สมัครร้านค้าใหม่</Link>
        </div>
      </form>
    </main>
  );
